...
func schema_k8s_apis_kilo_v1alpha1_PeerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PeerSpec is the description and configuration of a peer.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"allowedIPs": {
						SchemaProps: spec.SchemaProps{
							Description: "AllowedIPs is the list of IP addresses that are allowed for the given peer's tunnel.",
							Type:        []string{"array"},
