...
type peers struct {
	*gentype.ClientWithList[*v1alpha1.Peer, *v1alpha1.PeerList]
}

// newPeers returns a Peers
func newPeers(c *KiloV1alpha1Client) *peers {
	return &peers{
		gentype.NewClientWithList[*v1alpha1.Peer, *v1alpha1.PeerList](
			"peers",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			func() *v1alpha1.Peer { return &v1alpha1.Peer{} },
			func() *v1alpha1.PeerList { return &v1alpha1.PeerList{} }),
	}
}
