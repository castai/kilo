/*
Copyright 2024 Kilo & Cast AI Authors.
...
func (c *FakePeers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Peer, err error) {
	emptyResult := &v1alpha1.Peer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(peersResource, name, options), emptyResult)
	if obj == nil {
...
func (c *FakePeers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PeerList, err error) {
	emptyResult := &v1alpha1.PeerList{}
	obj, err := c.Fake.
		Invokes(testing.NewRootListActionWithOptions(peersResource, peersKind, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
...
func (c *FakePeers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchActionWithOptions(peersResource, opts))
}
...
func (c *FakePeers) Create(ctx context.Context, peer *v1alpha1.Peer, opts v1.CreateOptions) (result *v1alpha1.Peer, err error) {
	emptyResult := &v1alpha1.Peer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateActionWithOptions(peersResource, peer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1alpha1.Peer), err
...
func (c *FakePeers) Update(ctx context.Context, peer *v1alpha1.Peer, opts v1.UpdateOptions) (result *v1alpha1.Peer, err error) {
	emptyResult := &v1alpha1.Peer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateActionWithOptions(peersResource, peer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1alpha1.Peer), err
...
func (c *FakePeers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionActionWithOptions(peersResource, opts, listOpts)
...
func (c *FakePeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Peer, err error) {
	emptyResult := &v1alpha1.Peer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(peersResource, name, pt, data, opts, subresources...), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1alpha1.Peer), err
